...
public class _Email
{
	...
	/// Almacena un E-mail.
	/// </summary>
	public _Email(string de, string para, string cc, string asunto, string cuerpo)
    ...
    /// Almacena un E-mail.
    /// </summary>
    public _Email(string de, string para, string cc, string asunto, string cuerpo, List<AdjuntoEmail> adjuntos)
    {
        this.de = de;
        this.para = para;
        this.cc = cc;
