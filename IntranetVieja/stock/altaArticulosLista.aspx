<%@ Page Title="" Language="C#" MasterPageFile="~/MainTemplate.master" AutoEventWireup="true" CodeFile="altaArticulosLista.aspx.cs" Inherits="stock_altaArticulosLista" %>
...
<script language="javascript" type="text/javascript">
    ...
    function GetSolicitudes(pagina) {
        ...
        ConsultaAjax.url = 'altaArticulosLista.aspx/GetSolicitudes';
    ...
    function DibujarPaginasLista(idSolicito, estado) {
        ConsultaAjax.url = 'altaArticulosLista.aspx/GetCantidadPaginas';
    ...
    function VerSolicitud(idCA) {
        location.href = 'altaArticuloAdmin.aspx?p=' + idCA;
    }
</script>
...
<div class="page-title">
    <h1>Listado de solicitudes de alta de artículos</h1>
</div>
    ...
    <table class="tbl editable listado" cellspacing="0">
        <thead>
            <tr>
                ...
                <td class="border_middle" style="width:200px">Código</td>
